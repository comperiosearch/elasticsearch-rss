...
------
  ...
  rss info [-v] [-s <since>] [<nameList>]         Show feed/channel info
  rss add <name> <url>                            Add feed
  rss remove [-c]Â [<nameList>]                    Remove feed
  rss update [-v] [<namelist>]                    Update feed channel info
  rss list [-v] [-d] [-s <since>] [<nameList>]    List items in index
  rss clean [-b <before>] [<nameList>]            Clean items in index
  rss fetch [-v] [-d] [-f] [<nameList>]           Fetch items
